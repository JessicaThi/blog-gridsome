<template>
  <Layout :hideHeader="true" :disableScroll="true">
    <div class="container lg:pxi-0 mx-auto overflow-x-hidden pt-20 md:pt-24">
      <div class="lg:mx-32 md:mx-16 sm:mx-8 mx-4 pt-8">
        <section class="post-header container mx-auto px-0 mb-4 border-b">
          <span
            class="uppercase text-sm font-medium tracking-wide text-red-500 mt-3"
          >
            <g-link :to="$page.blog.category.path" class="hover:underline">{{
              $page.blog.category.title
            }}</g-link>
          </span>
          <h1 class="text-5xl font-medium leading-none mt-1">
            {{ $page.blog.title }}
          </h1>
          <div
            class="text-2xl pt-1 pb-4 text-gray-700"
      ...
      <section class="post-image mx-auto w-full">
        <g-image :src="$page.blog.image" quality="85"></g-image>
    ...
    <section
      class="post-related bg-black text-gray-200 pt-10 px-4 border-b border-b-gray-900"
    >
