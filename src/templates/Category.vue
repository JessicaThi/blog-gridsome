<template>
  <Layout :hideHeader="true" :disableScroll="true">
    <div class="container min-height-custom lg:pxi-0 mx-auto overflow-x-hidden pt-20 md:pt-24">
      ...
      <div v-if="$page.category.belongsTo.pageInfo.totalPages > 1" class="pagination flex justify-center mb-8" >
        <Pagination
...
export default {
  ...
  computed: {
    postLabel: function() {
      ...
      return pluralize("article", this.$page.category.belongsTo.totalCount);
    }
  },
  metaInfo() {
    return {
